...
export class default1659984264521 implements MigrationInterface {
    name = 'default1659984264521'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "impressoras" ("id" SERIAL NOT NULL, "impressora" text NOT NULL, "modelo" text NOT NULL, "ip" text NOT NULL, "departamento_id" integer, CONSTRAINT "PK_fb38412cc8b62113cfff2e6982f" PRIMARY KEY ("id"))`);
